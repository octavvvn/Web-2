...
if (isset($_POST["submit"])) {
    ...
    $data = [$_kode, $_nama, $_tmp_lahir, $_tgl_lahir, $_gender, $_alamat, $_unit_kerja_id];
    $sql = "INSERT INTO dokter (kode, nama, tmp_lahir, tgl_lahir, gender, alamat, unit_kerja_id) VALUES (?,? ,? ,? ,? ,? ,?)";
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <select id="unit_kerja_id" name="unit_kerja_id" class="custom-select">
                                            ...
                                            ?>
                                                <option value="<?= $rowUnitKerja['id'] ?>"><?= $rowUnitKerja['nama'] ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
