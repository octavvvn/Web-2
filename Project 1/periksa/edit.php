...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    // Query to retrieve examination data based on ID
...
if (isset($_POST['submit'])) {
    ...
    // SQL query to update examination data based on ID
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="berat_badan" class="col-4 col-form-label">Berat</label>
                                    <div class="col-8">
                                        <input id="berat" name="berat" type="text" class="form-control" value="<?= $row['berat'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="tinggi_badan" class="col-4 col-form-label">Tinggi</label>
                                    <div class="col-8">
