...
if (isset($_POST['submit'])) {
    ...
    $data = [$_kode, $_nama, $_tmp_lahir, $_tgl_lahir, $_gender, $_kategori, $_telpon, $_alamat, $_unit_kerja_id, $id];
    $sql = "UPDATE dokter SET kode = ?, nama = ?, tmp_lahir = ?, tgl_lahir = ?, gender = ?, kategori = ?, telpon = ?, alamat = ?, unit_kerja_id = ? WHERE id = ?";
    $stmt = $dbh->prepare($sql);
    $stmt->execute($data);
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <select id="unit_kerja_id" name="unit_kerja_id" class="custom-select">
                                            ...
                                            $rsUnitKerja = $dbh->query($sqlUnitKerja);
                                            foreach ($rsUnitKerja as $rowUnitKerja) {
                                                $selected = ($row['unit_kerja_id'] == $rowUnitKerja['id']) ? 'selected' : '';
                                                echo "<option value='" . $rowUnitKerja['id'] . "' $selected>" . $rowUnitKerja['nama'] . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
